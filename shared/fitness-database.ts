...
export const FITNESS_DATABASE = {
  ...
  healthGoals: [
    ...
    {
      goal_id: 3,
      goal_name: "Reduce stress/Manage my mood better",
    ...
    {
      goal_id: 4,
      goal_name: "Improve sleep quality",
  ...
  healthConditions: [
    ...
    },
    {
      ...
      workout_focus_add: ["low impact", "core strengthening"],
      workout_activities_add: ["swimming", "pilates", "walking"],
      workout_activities_avoid: ["high impact during heavy periods"],
      nutrition_nutrients_add: ["iron", "fiber", "antioxidants"],
      nutrition_foods_add: ["leafy greens", "berries", "whole grains"],
      nutrition_foods_avoid: ["processed meats", "high sugar"],
      special_instructions: "Support healthy circulation"
    },
    {
      condition_id: 5,
  ...
  fitnessLevels: [
    {
      fitness_id: 1,
      fitness_level: "I'm just starting out",
    ...
    {
      fitness_id: 2,
      fitness_level: "I'm getting back into it",
    ...
    {
      fitness_id: 3,
      fitness_level: "I'm already pretty active",
    ...
    {
      fitness_id: 4,
      fitness_level: "I'm very experienced with fitness",
